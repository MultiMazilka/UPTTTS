...
function TBHUD:CacheEnts()
	if IsValid(LocalPlayer()) and (LocalPlayer():IsActiveTraitor() or LocalPlayer():IsActiveKiller()) then
		self.buttons = {}
...
function TBHUD:PlayerIsFocused()
	return IsValid(LocalPlayer()) and (LocalPlayer():IsActiveTraitor() or LocalPlayer():IsActiveKiller()) and IsValid(self.focus_ent)
end
