...
L.win_innocent     = "Предатели убиты"
...
--- Credit awards
L.credit_det_all   = "Детективы награждены {num} кредитами за ваши действия."
L.credit_tr_all    = "Предатели, вы награждены {num} кредитами за ваши действия."

L.credit_kill      = "Вы получили {num} кредитов за убийство."

--- Karma
L.karma_dmg_full   = "Ваша карма {amount}, и вы наносите больший урон в этом раунде!"
L.karma_dmg_other  = "Ваша карма {amount}. Ваш урон понижен на {num}%"

--- Body identification messages
L.body_found       = "{finder} нашел тело {victim}. {role}"

-- The {role} in body_found will be replaced by one of the following:
L.body_found_t     = "Он был Предатель!"
L.body_found_d     = "Он был Детективом."
L.body_found_i     = "Он был невиновен."
L.body_found_k     = "Он был киллером."
...
L.body_burning     = "Черт! Это тело горит!"
...
L.equip_help_carry = "Вы можете покупать вещи для которых у вас есть место."
L.equip_carry      = "Вы можете нести это."
L.equip_carry_own  = "Вы уже имеете это."
...
L.equip_custom     = "Особый предмет добавленный сервером"
...
L.disg_help1     = "Если активна, она скрывает ваш счет, карму и кол-во убийств от всех. + скрывает вас от радара детектива."
L.disg_help2     = "Нажмите NUMPAD Enter для активации Маскировки."

-- Radar tab in equipment menu
L.radar_name      = "Радар"
L.radar_menutitle = "Контроль радара"
L.radar_not_owned = "Просканировать"
L.radar_scan      = "Повторить сканирование"
...
L.radar_charging  = "Ваш радар снова работает!"

-- Transfer tab in equipment menu
L.xfer_name       = "Перевод"
L.xfer_menutitle  = "Перевести кредиты"
L.xfer_no_credits = "У вас недостаточно кредитов для перевода!"
L.xfer_send       = "Передать кредиты"
L.xfer_help       = "Ты можешь пересылать кредиты только игрокам в роли {role}."

L.xfer_no_recip   = "Получатель не действителен, кредиты не переданы."
L.xfer_no_credits = "Недостаточно кредитов для перевода."
L.xfer_success    = "Переведены кредиты игроку {player}."
L.xfer_received   = "{player} перевёл вам {num} кредитов."
...
L.intro_help     = "Если ты новичок, нажми F1 для помощи!"

-- Chat-related
L.spec_teamchat_hint = "ПОДСКАЗКА: За наблюдателя ты можешь говорить только в TEAM чат!"
L.inno_globalchat_hint = "Если ты невиновный, используй глобальный чат для разговора."
...
L.search_role_k = "Он был Киллером."
...
L.search_c4     = "В его кармане ты нашел записку. В ней сказано что нужно перерезать {num}-й провод чтобы безопасно обезвредить бомбу."
...
L.search_time   = "Он умер за {time} минут пока вы его не обыскали."
L.search_dna    = "Он умер совсем недавно и на нем осталась ДНК убийцы! У вас есть {time} чтобы его отсканировать."

L.search_kills1 = "Ты нашел список убийств что подтверждает смерть {player}."
L.search_kills2 = "В списке убийств были следующие имена:"
L.search_eyes   = "Используя свои навыки детектива вы выяснили, что последний кого видел данный человек был: {player}. Убийца или свидетель?"
...
L.sb_karma      = "Карма"
L.sb_rank		= "Ранг"
L.sb_admins		= "Админы Онлайн"
L.sb_rules		= "Правила"
L.sb_donat		= "Донат"
L.sb_copyname	= "Копировать имя"
L.sb_copysteam	= "Копировать SteamID"
L.sb_openprofile	= "Открыть Профиль"
L.sb_adminmenu 	= "Админ"
L.sb_slaynr		= "Убить в След. Раунде"
L.sb_slay		= "Убить сейчас"
L.sb_kick		= "Выгнать"
L.sb_mute		= "Заткнуть"
L.sb_gag	= "Заглушить"
L.sb_goto		= "Перейти к нему"
L.sb_bring		= "Притащить его"
L.sb_spectate	= "Наблюдать"
L.sb_superadminmenu = "Суперадмин"
L.sb_frienscheck = "Проверить друзей"
L.sb_ban	= "Забанить"
L.sb_ban60	= "На 1 час"
L.sb_ban360	= "На 6 часов"
L.sb_ban720	= "На 12 часов"
L.sb_ban1440	= "На 24 часа"
L.sb_ban2880	= "На 2 дня"
L.sb_ban7200	= "На 5 дней"
L.sb_ban10080	= "На неделю"
L.sb_banperm	= "Навсегда"
L.sb_dban	= "Список вышедших игроков"
L.sb_forcenr	= "Сделать в след. раунде"
L.sb_forcenrtr	= "Предателем"
L.sb_forcenrde	= "Детективом"
L.sb_forcenrno	= "Убрать назначение"
L.sb_proptime	= "ПропТайм"
L.sb_proptime_start	= "Начать"
L.sb_proptime_end	= "Вернуть все обратно"
L.sb_respawn	= "Возродить"
L.sb_srespawn	= "Возродить тихо"
L.sb_giveweapons	= "Дать оружие"
L.sb_god	= "Бессмертие"
L.sb_god_do	= "Дать бессмертие"
L.sb_ungod	= "Отнять бессмертие"
L.sb_launch	= "Запустить в воздух"
L.sb_stopsouns	= "Остановить звуки"
L.sb_cleardecals	= "Отчистить декали"
L.sb_restartserver	= "Перезагрузить сервер?"
L.sb_restartserver_no	= "Не перезагружать сервер"
L.sb_restartserver_yes	= "Да, перезагрузить!"
L.sb_banunknown_desc	= "Дайте мне просто его забанить!"
...
L.set_tips      = "Показывать подсказки внизу"
...
L.set_specmode      = "Режим 'Наблюдателя' "
L.set_specmode_tip  = "Режим наблюдателя не позволит вам возрождаться в раундах пока вы его не выключите."
...
L.c4_disarmed     = "Вы успешно деактивировали бомбу! Так держать."
...
L.c4_disarm_t     = "Вы - Предатель. Перережьте любой провод для деактивации бомбы. Для невинвных это не так легко!"
...
будут видеть вашу метку вместо вас на радаре.]]
...
-- Poltergeist
L.polter_desc     = [[
Закладывает ускорители на объекты
...
L.sipistol_desc   = [[
Этот пистолет не издает лишнего шума
...
он делает вас непобедимым, почти.]]
...
L.tele_no_ground  = "Невозможно телепортироваться, пока вы не встали на твердую поверхность!"
...
L.tele_no_mark_ground = "Невозможно пометить точку телепортации, пока вы не встали на твердую поверхность!"
...
L.tele_help_sec   = "{secondaryfire} помечает эту точку."

L.tele_desc       = [[
Телепортирует вас к отмеченной точке.

Телепортация издает звук и лимит использования
ограничен.]]
...
L.idle_popup = [[Вы не двигались в течении {num} секунд и были переведены в режим 'Наблюдателя'. Пока вы в нем - вы не будете возрождаться.

Вы можете отключить режим 'Наблюдателя' нажатием {helpkey} и в меню 'Настройки' снимите галочку с 'Только наблюдение'.]]

L.idle_popup_close = "Ничего не Делать"
L.idle_popup_off   = "Отключить режим наблюдения"

L.idle_warning = "Внимание: Возможно вы АФК. Если вы не покажете свою активность вы будете переведены в режим 'Наблюдателя'!"

L.spec_mode_warning = "Вы в режиме Наблюдения и не будете возрождаться. Чтобы отключить этот режим - зайдите в настройки и снимите галочку с 'Режим наблюдателя'."
...
L.ev_tele        = "{victim} былы телефрагнут {attacker}"
L.ev_tele_using  = "{victim} был расплющен {trap} ,установленный {attacker}"

L.ev_goomba      = "{victim} был раздавлен огромной тушей {attacker}"
...
L.ev_other_using = "{victim} был убит {attacker} ,воспользовавшись {trap}"

-- Other events
L.ev_body        = "{finder} нашел тело {victim}"
L.ev_c4_plant    = "{player} заложил С4"
L.ev_c4_boom     = "С4 заложенная {player} взорвалась"
L.ev_c4_disarm1  = "{player} обезвредил С4, заложенную {owner}"
L.ev_c4_disarm2  = "{player} ошибся при разминирований С4, заложенной {owner}"
L.ev_credit      = "{finder} нашел {num} кредита(ов) на теле {player}"

L.ev_start       = "Раунд начался"
L.ev_win_traitor = "Подлые Предатели выйграли раунд!"
L.ev_win_inno    = "Всеми любимые Невиновные выйграли этот раунд!"
L.ev_win_time    = "У предателей истекло время и они проиграли!"
...
L.aw_hug2_text  = "просто не стрелял без остановки со своего H.U.G.E. Когда все стихло, он обнаружил, что убил {num} людей."
...
L.aw_tkl1_title = "Игровой шок"
L.aw_tkl1_text  = "случайно сдвинул палец со спускового крючка, когда смотрел на напарника. Вот идиот..."
...
L.aw_tkl4_text  = "убил всю свою команду."
...
L.aw_tkl6_text  = "cне понял на чьей он стороне и по-этому убил половину своих друзей."
...
L.set_avoid_det_tip = "Вылючите это для того чтобы не становиться Детективом. Это не значит что вы будете становиться Предателем чаще."
...
L.slam_desc   = [[
Лазерная мина, которую можно обезвредить.
]]

L.slam_warn   = [[
Ваша лазерная мина удачно обезврежена.]]

L.slam_carry = [[
У вас нету места для Лазерной мины.
]]

L.awp_desc   = [[
Мощное, но шумное, оружее дальнего поражения.
Убивает в любую часть тела.]]

L.cannibalism_name   = "Каннибализм"

L.cannibalism_desc   = [[
Два в одном! И жизни восстановить,
И избавиться от трупа!]]

L.angry_cat   = "Злая кошка"

L.cat_desc   = [[
Воспитывалась в секте каннибалов и джихадов,
что очень плачевно...

Разозленная кошка может 
взорвать огромную толпу людей!]]

L.death_station   = "Станция 'Смерти'"

L.death_station_desc   = [[
Обманка для глупых Невиновных.
Замаскированная Лечебная станция.
Но теперь она лечит только вас, а убивает
раненых Невиновных.]]

L.df_name   = "Фальш-Смерть"

L.df_desc   = [[
Имитатор вашей смерти.
Просто скиньте ваш труп, но не попадайтесь на глаза!
Кнопкой R можно выбрать причину смерти.]]

L.def_name   = "Дефибриллятор"

L.def_desc   = [[
Оживите своих напарников без особых усилий!]]

L.railgun_name   = "Рейлган"

L.railgun_desc   = [[
Вы в детстве хорошо играли в Quake?
Если да, то это пушка вам точно подходит.
Воплотите свои старческие замыслы!
]]

L.rigger_name   = "Риггер"

L.rigger_desc   = [[
Оружие позволяющее вам 'начинить' труп или проп
чистой взрывчаткой!]]

L.ax47_name   = "AX-47"

L.ax47_desc   = [[
AX-47 - возможно любимое оружие
предателей. Скорострельный, мощный и стильный,
он делает вас непобедимым...почти.
Теперь с персональным топором!
]]


L.beretta_name   = "Беретта"

L.freeze_desc   = [[
 Вы с уверенностью можете
 остудить пыл своим врагам по жизни,
 благодая этой гранате вы превратите
 их в ледышку на 4 секунды.
]]

L.freeze_name   = "'Ледяная комета'"
L.cash_name   = "PointShop Деньги"
L.jihad_name = "Шахидка"
L.jihad_desc = [[
 Это ваш карманный Аллах
 для устраивания оргомных 
 погромов. Устройте на сервере
 9-ое сентября ценою своей 
 жизни.
]]

L.death_stat_hud = "Станцию смерти смогут использвать только раненые игроки."
